...
[filename,element,node]=generate_input(l,SF,IP);


[d,exact_disp,exact_stress_nodes,exact_stress_ips,fem_stress_nodes,fem_stress_ips,Rxn,node,ip_coords]=FEA_solver(filename,l);
...
function [d,exact_disp,exact_stress_nodes,exact_stress_ips,fem_stress_nodes,fem_stress_ips,Rxn,node,ip_coords]=FEA_solver(filename,l)
